...
1. **Is this change additive and optional?**
   _(Explain how older parsers will safely ignore these new fields without crashing)_
2. **Graceful Degradation Strategy:**
   _(Describe how legacy WebGL2 engines or older VTTs should handle/render this feature if they don't support the recommended WebGPU/compute-shader implementation)_
