...
Once the key is retrieved, the VTT can use it to decrypt premium .uvtt2z payloads,
unlocking high-resolution WebP images, ambient audio, and the complete geometry.json
file (which includes the encrypted line-of-sight walls, portals, and semantic movement zones).
...
def fetch_decryption_key(endpoint: str, map_id: str, license_key: str, verbose: bool = False) -> str:
    ...
    headers = {
        ...
        "User-Agent": "UVTT-v2-ZKS-Client/1.1"
    }
...
def main():
    ...
    try:
        ...
        print("[✔] You can now decrypt the .uvtt2z archive, including its semantic zones.")
        sys.exit(0)
